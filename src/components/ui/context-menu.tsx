// Trimmed to what job-context-menu.tsx actually uses (Root/Trigger/Content/
// Item/Separator) rather than porting shadcn's full generated set —
// Sub/RadioGroup/Checkbox items have no caller anywhere in this app.
